...
public class ResourceService {
    ...
    public static final String UPLOAD_FILE = "/home/ttn/linksharing/src/main/resources/static/downloadresourceFiles/";
...
//        List<Resource> resourcesSubscribed = resourceRepository.findAllByTopicIn(topicsOfUser);
    ...
    public List<Resource> getTopPost() {
        ...
        List<Resource> allResourcess = new ArrayList<>();
        resources.forEach(allResourcess::add);
        ...
        Iterator<Resource> resourceIterator = allResourcess.iterator();

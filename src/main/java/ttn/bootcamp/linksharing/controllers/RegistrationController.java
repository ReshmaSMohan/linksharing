...
public class RegistrationController {
    ...
    public String registerUser(@Valid @ModelAttribute("user") User user, BindingResult result, Errors errors, @RequestParam("pic") MultipartFile file, HttpSession session) {
